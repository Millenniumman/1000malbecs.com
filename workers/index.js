  ...
  <!-- ==================== HEADER MOBILE CON CARRITO ==================== -->
      ...
      <div class="topbar">
        ...
        <div style="display:flex; align-items:center; gap: 25px;">
          ...
          <!-- Carrito Desktop -->
          <a href="/${lang}/carrito.html" style="position: relative; text-decoration: none; color: #4A2C59; font-size: 1.75em;">
            🛒
            <span id="cart-count" style="position:absolute; top:-8px; right:-8px; background:#e74c3c; color:white; font-size:12px; font-weight:bold; min-width:19px; height:19px; border-radius:50%; display:flex; align-items:center; justify-content:center; line-height:1;">0</span>
          </a>
        </div>
      </div>
    `;
